	...
	<div class="event-container">
		...
		<div class="info-container">
			...
			<small>
				...
				// Startzeit
				$scoutnet_isEndSet = trim($event->End)!="" && trim($event->Start) != trim($event->End);
				if (trim($event->Start)!="") {
					echo "Start: " . date('G:i', $event->Start) . "Uhr";
					if(!$scoutnet_isEndSet)
						echo "<br />";
				}
				// Endzeit
				if ($scoutnet_isEndSet) {
					echo " — ";
					echo "Ende: " . date('G:i', $event->End) . "Uhr<br />";
				}
...
//						echo "Autor: " . $event->Author->get_full_name();
						echo " (ge&auml;ndert am " . date('d.m.Y', $event->Last_Modified_At) . ")";
					} else {
//						echo "Autor: " . $event->Author->get_full_name();
						echo " (ge&auml;ndert am " . date('d.m.Y',$event->Created_At) . ")";
					}
				}
				?>
			</small>
